...
public class ActivitySport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eventAdapter.setOnItemClickListener(new EventAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(ActivitySport.this, BookingActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            Intent intent = new Intent(ActivitySport.this, MainActivity.class); // Go back to MainActivity
            startActivity(intent);
            finish();
            return true;
        }
